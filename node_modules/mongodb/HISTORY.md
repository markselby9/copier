...
* NODE-606 better error handling on destroyed topology for controller.js methods.
...
* Added db(dbName) method to controller.js to allow for reuse of connections against other databases
